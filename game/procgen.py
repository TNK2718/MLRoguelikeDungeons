...
def place_entities(room: RectangularRoom, dungeon: game.game_map.GameMap,
...
def tunnel_between(engine: game.engine.Engine, start: Tuple[int, int],
...
def generate_dungeon(
    ...
    for _ in range(max_rooms):
        ...
        if len(rooms) == 0:
            ...
            for x, y in tunnel_between(engine, rooms[-1].center,
                                       new_room.center):
